...
; (function ($) {
    ...
    var browser = function(c) {var b = "";var d = {ie: /msie (\d+\.\d+)/i.test(c) ? window.document.documentMode || +RegExp.$1 : b};return d;}(navigator.userAgent);
...
//                });
        ...
        show: function (el, ordinal) {
            ...
            try {
              ...
              $el.data('focusedelementbeforepopup', document.body);
            }
